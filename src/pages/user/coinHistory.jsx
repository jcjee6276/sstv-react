...
import {Modal,Add_at,Exchange_button,Btn_cancel,Table_title1,Tabke_span,Add_st_dd,Btn_gift,Add_btn_area,Add_st_span,Add_dt,Add_coin_input,Add_count,Add_st_dt,Add_st_dl,Add_strong,Add_txt_span,Add_dd,Add_Ticket,Add_txt_span_tkName,Pop_ticket_div,PurchaseList_div,Purchase_title,Purchase_notice_p,Button_div ,Table_td,Table_title,Purchase_table,Colgroup,Table_tr,Table_th,Purchase_button,Col,Table_thead} from "../Exchange/style";
  ...
  return(
    ...
    {/* header */}
      ...
      <User_update_titleLine>
        ...
        <div>
        <PurchaseList_div>
            <Purchase_title>코인사용 내역</Purchase_title>
            <Table_title1>
