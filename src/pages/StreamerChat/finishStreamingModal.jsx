        ...
        <Modal id='modalArea' ref={modalRef}>
            <Layer_in>
                <Send_area>
                    <Gift_at>
                        <Gift_dt>
                            <Gift_strong>스트리밍 종료를 원하면 '스트리밍 종료'를 입력하세요</Gift_strong>
                        </Gift_dt>
                        <Gift_dd>
                            {/* <Gift_dd_span>선물할 코인</Gift_dd_span> */}
                            <Gift_dd_input value={inputText} onChange={handleInputText}></Gift_dd_input>
                    ...
                    <Gift_st>
                        ...
                        <ST_dd_error>
                            ...
                            <ST_dd_error_span>텍스트가 올바르지 않습니다.</ST_dd_error_span>
                        </ST_dd_error>
                        :
                        <Button_area>
                            <Button_gift_button onClick = {() => onClick()}>스트리밍 종료</Button_gift_button>
                        </Button_area>
                        }
                    </Gift_st>
